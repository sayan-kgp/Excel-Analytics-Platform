...
const WelcomePage = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-blue-500 to-indigo-700 text-white p-4'>
            <div className='text-center bg-white/20 backdrop-blur-lg rounded-xl p-8 md:p-12 max-w-lg w-full transform transition-all duration-500 ease-in-out scale-95 hover:scale-100'>
